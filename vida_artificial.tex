...
Para esto se evaluaron 3 poblaciones (lo cual se ilustra en la figura ~\ref{fig:mosquitos}):
\begin{itemize}
...
\begin{figure}[ht]
\centering
  \includegraphics[width=5cm,height=5cm]{img/openworm.JPG}
